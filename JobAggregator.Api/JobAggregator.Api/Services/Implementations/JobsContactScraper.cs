...
namespace JobAggregator.Api.Services.Implementations
{
    public class JobsContactScraper : IJobScraper
    {
        ...
        public JobsContactScraper(IJobPostingRepository jobPostingRepository, ILogger<JobsContactScraper> logger)
        {
        ...
        {
            using (_logger.BeginScope(new Dictionary<string, object> { ["Scope"] = "[JobsContact] " }))
            {
